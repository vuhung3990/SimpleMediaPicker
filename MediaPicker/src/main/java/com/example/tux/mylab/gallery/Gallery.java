...
/**
 * input builder for gallery<br/> <p>- view type = time</p> <p>- multi choice = false</p>
 */
@Keep
public class Gallery implements Parcelable {
  ...
  public static final class Builder {
    ...
    /**
     * available values <p>{@link #VIEW_TYPE_FOLDER}</p> <p>{@link #VIEW_TYPE_PHOTOS}</p> <p>{@link
     * #VIEW_TYPE_VIDEOS}</p> <p>{@link #VIEW_TYPE_TIME}</p> <p>{@link #VIEW_TYPE_PHOTOS_ONLY}</p>
    ...
    /**
     * true: crop after pick or take photo <p>NOTE crop after pick image only work:</p> <p>- {@link
     * #multiChoice(boolean)} = false</p> <p>- selected item is photo</p>
     */
